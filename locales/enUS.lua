...
L['Blizzard Micromenu Disclaimer'] = 'This option is disabled because an external bar manager was detected: %s.'
L['Blizzard Bags Bar'] = true
L['Disable Blizzard Bags Bar'] = true
L['Blizzard Bags Bar Disclaimer'] = 'This option is disabled because an external bar manager was detected: %s.'
