...
L['Blizzard Micromenu Disclaimer'] = "Cette option est désactivée car un gestionnaire de barres externe est détecté : %s."
L['Blizzard Bags Bar'] = "Barre des sacs Blizzard"
L['Disable Blizzard Bags Bar'] = "Désactiver la barre des sacs Blizzard"
L['Blizzard Bags Bar Disclaimer'] = "Cette option est désactivée car un gestionnaire de barres externe est détecté : %s."
